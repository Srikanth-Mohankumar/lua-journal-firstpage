...
luatexbase.add_to_callback('pre_linebreak_filter', pre_linebreak, 'tnqjournal.pre_linebreak')
luatexbase.add_to_callback('post_linebreak_filter', post_linebreak, 'tnqjournal.post_linebreak')
luatexbase.add_to_callback('buildpage_filter', buildpage_filter, 'tnqjournal.buildpage_observer')
luatexbase.add_to_callback('pre_output_filter', pre_output_filter, 'tnqjournal.pre_output_observer')
